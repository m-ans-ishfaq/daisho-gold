...
{
    return (
        <section id="rules-and-regulations" className="mt-4 grid grid-cols-1 gap-8 md:grid-cols-2 text-justify">
            <div className="space-y-2">
                <h4 className="mb-4 text-2xl font-semibold">Rules & regulations of website</h4>
                <div className="space-y-2">
                    <p><strong>Copyright Laws:</strong> Respect copyright laws by not using copyrighted material without permission.</p>
                    <p><strong>Privacy Policy:</strong> Include a privacy policy that explains how you collect, use, and protect.</p>
                    <p><strong>Accessibility:</strong> Ensure your website is accessible to people with disabilities, following guidelines such as the Web Content Accessibility Guidelines (WCAG).</p>
                    <p><strong>Terms and services:</strong> Clearly outline the terms and conditions that users must agree to when using your website.</p>
                    <p><strong>Cookie Policy:</strong> If your website uses cookies, provide a clear explanation of their purpose and obtain consent from users.</p>
                    <p><strong>GDPR Compliance:</strong> If you operate in the European Union or process data of EU citizens, comply with the General Data Protection Regulation (GDPR).</p>
                    <p><strong>Content Guidelines:</strong> Avoid publishing illegal, harmful, or offensive content.</p>
            ...
            <div className="space-y-2">
                <h4 className="mb-4 text-2xl font-semibold">Rules and regulations for customers</h4>
                <ul className="space-y-2">
                    ...
                    <li>Customers must always adhere to safe and responsible cycling practices while using the products purchased from the website.</li>
                    <li>Customers can not return or exchange the product sent to them online.</li>
                </ul>
            </div>
        </section>
    )
